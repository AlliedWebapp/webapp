...
const PROJECTS = {
  jogini: {
    ...
    columns: [
      ...
      { key: "OPENING STOCK ( NOS )", label: "Opening Balance" },
      { key: "RECEIVED QTY ( NOS )", label: "Received during month" },
      { key: "Monthly Consumption ( NOS )", label: "Issued during Month" },
      { key: "issued during year", label: "Issued during Year" },
      { key: "CLOSING STOCK ( NOS )", label: "Closing Balance" },
  ...
  shong: {
    label: "Shong",
    columns: [
      { key: "Description of Material", label: "Spare description" },
      { key: "Make", label: "manufacture" },
      { key: "Vendor", label: "Vendor" },
      { key: "Opening Balance", label: "Opening Balance" },
      { key: "Received during Month", label: "Received during month" },
      { key: "Issued during Month", label: "Issued during Month" },
      { key: "Issued during Year", label: "Issued during Year" },
